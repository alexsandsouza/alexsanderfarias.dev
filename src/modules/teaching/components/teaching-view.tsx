          ...
          <div className="pt-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={prog}
                  className="text-xs font-mono text-slate-300 bg-surface border border-border-subtle px-3 py-1 rounded-md"
                >
                  {prog}
                </span>
              ))}
              ...
              <div className="pt-4 border-t border-border-subtle/60 flex items-center justify-between">
                ...
                <div className="flex flex-wrap gap-1">
                  {course.tools.map((tool) => (
                    <span
                      key={tool}
                      className="text-[10px] font-mono text-slate-300 bg-surface-elevated border border-border-subtle px-2 py-0.5 rounded"
                    >
                      {tool}
                    </span>
                  ))}
